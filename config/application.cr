...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Realtime Chat Crystal Amber web application."
  #
  #
  ...
  #
  # settings.secret_key_base= V0K1HzaLmJB0TnlSCZHKC_Sncr8rTbfX9cFvoI4A2Bc
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("realtime-chat-crystal-amber.log", "w"))
  #
  #
end
